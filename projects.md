...
<div class="project-list">
  <div class="project-item">
    <div class="project-name"><a href="https://github.com/jimyeong/ops-check-service">Ops Check Service</a></div>
    <div class="project-desc">Reliability-focused backend for ingesting sensor data, handling state transitions, and delivering notifications. Built to monitor my flat's humidity and prevent mould damage.</div>
